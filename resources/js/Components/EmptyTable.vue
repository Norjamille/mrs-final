<template>
    <tr>
        <Tcell :colspan="props.colspan">
            <div class="grid my-10 space-y-3">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" class="mx-auto h-52"
                    ...
                    <path
                        ...
                        transform="translate(-276.18187 -133.91309)" fill="#f74279" />
                    <circle cx="190.15351" cy="24.95465" r="20" fill="#f74279" />
                    ...
                    <path
                        ...
                        transform="translate(-276.18187 -133.91309)" fill="#f74279" />
                    <circle cx="433.63626" cy="105.17383" r="20" fill="#f74279" />
