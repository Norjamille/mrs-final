    ...
    <div>
      <div>
        ...
        <p style="font-size: 1.25rem; font-weight: 600; text-align: center; margin-top: 20px;">
            Number of Vaccinated Infants
        </p>
      </div>
      <table style="border-collapse: collapse; width: 100%; margin-top: 20px;">
        <tr style="background-color: #D9D9D9; height: 18.75pt;">
          <th style="border: 1px solid #000000; padding: 0.9375rem; text-align: left;">Total Vaccinated Infants</th>
          <th style="border: 1px solid #000000; padding: 0.9375rem; text-align: left;">{{ $count }}</th>
        </tr>
      </table>
    </div>
    <script>
